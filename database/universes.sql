...
ALTER TABLE public.worlds_robots ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.worlds_robots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
1	Vacuums House	24	1
2	City Large	8	1
3	Rescue Default	20	1
4	Warehouse 1	27	1
5	Simple Circuit	23	1
6	Montreal Circuit	16	1
7	Follow Person	10	1
8	Follow Person Teleop	11	1
9	Autoparking Simple: In line	7	1
10	Obstacle Avoidance Default	19	1
11 	City Large Followcam	9	1
12 	3d Reconstruction	1	1
13 	Autoparking Simple: In battery	6	1
14 	Autoparking Gas Station: In line	3	1
15 	Autoparking Gas Station: In battery	2	1
16 	Autoparking Gas Station: Parking lot	4	1
17 	Warehouse 1 Ackermann	28	1
18 	Warehouse 2 Ackermann	30	1
19	Warehouse 2	29	1
20 	Montmelo Circuit	14	1
21 	Nurburgring Circuit	18	1
22 	Nurburgring Ackermann Circuit	17	1
23 	Montmelo Ackermann Circuit	13	1
24 	Montreal Ackermann Circuit	15	1
25 	Simple Ackermann Circuit	22	1
26	Autoparking Lidar Simple: In line	5	1
27	Vacuums House Roof	26	1
28	Restaurant	21	1
29	Vacuums House Markers	25	1
30	Laser Mapping Warehouse	12	1
\.
...
COPY public.robots (id, name, launch_file_path, ros_version, visualization, type) FROM stdin;
1	Vacuum	/opt/jderobot/Launchers/vacuum_cleaner.launch.py	ROS2	gazebo_rae	gazebo
2	F1 Renault	/opt/jderobot/Launchers/taxi_navigator.launch.py	ROS2	gazebo_rae	gazebo
3	Turtlebot 3	/opt/jderobot/Launchers/robots/turlebot3.launch.py	ROS2	gzsim_rae	gazebo
\.
...
COPY public.worlds_robots (id, world_id, robot_id) FROM stdin;
1	1	3
2	2	3
3	3	3
4	4	3
...
SELECT pg_catalog.setval('public.worlds_robots_id_seq', 1, false);
